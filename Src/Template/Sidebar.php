        ...
        <div class="mdui-drawer mdui-card" id="drawer" style="border-radius: 0;">
            ...
            <ul class="mdui-list">
                ...
                <div class="mdui-collapse" mdui-collapse>
                    ...
                    <!-- 独立页面 -->
                    <div class="mdui-collapse-item mdui-collapse-item-<?php echo Get::Options("SidebarNavPage"); ?>">
                        <div class="mdui-collapse-item-header mdui-list-item mdui-ripple">
                        ...
                        <div class="mdui-collapse-item-body mdui-list">
                            ...
                            while ($pages->next()): 
                            ?>
                            <a href="<?php echo $pages->permalink; ?>" class="mdui-list-item mdui-ripple">
                    ...
                    <!-- 翻译 -->
                    <?php if (Get::Options("SidebarTranslateOpen") === 'open'): ?> 
